...
if (!$hasArticles) {
    $dashboardUrl = assetUrl('admin/dashboard.php');
    $newArticleUrl = assetUrl('admin/article-new.php');
    ?>
    <section class="container empty-state">
        <div class="empty-state__content">
            <h1>Henüz haber bulunmuyor</h1>
            <p>Yayınlanmış haber bulunmadığı için anasayfa şu anda boş. Yönetim panelinden yeni haber eklediğinizde içerikler otomatik olarak burada görüntülenecektir.</p>
            <?php if (isApplicationInstalled()): ?>
                <div class="empty-state__actions">
                    <a class="btn" href="<?php echo htmlspecialchars($newArticleUrl, ENT_QUOTES, 'UTF-8'); ?>">İlk haberi oluştur</a>
                    <a class="link" href="<?php echo htmlspecialchars($dashboardUrl, ENT_QUOTES, 'UTF-8'); ?>">Yönetim paneline git</a>
                </div>
            <?php endif; ?>
        </div>
    </section>
...
$articleBaseUrl = assetUrl('article.php');
$categoryBaseUrl = assetUrl('category.php');
$searchBaseUrl = assetUrl('search.php');
$indexUrl = assetUrl('index.php');
...
<section class="hero">
    <div class="container hero-grid">
        <article class="hero__featured">
            <a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($featuredArticle['slug']), ENT_QUOTES, 'UTF-8'); ?>" class="hero__image" aria-label="<?php echo htmlspecialchars($featuredArticle['title'], ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <div class="hero__content">
                ...
                <h1><a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($featuredArticle['slug']), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($featuredArticle['title'], ENT_QUOTES, 'UTF-8'); ?></a></h1>
        ...
        <div class="hero__side">
            ...
            <?php foreach ($secondaryArticles as $article): ?>
                <article class="headline">
                    ...
                    <h3><a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?></a></h3>
...
<section class="breaking-news">
    <div class="container">
        <div class="breaking-news__header">
            <h2>Son Dakika</h2>
            <a class="link" href="<?php echo htmlspecialchars($searchBaseUrl . '?q=son+dakika', ENT_QUOTES, 'UTF-8'); ?>">Tüm son haberler</a>
        </div>
        <div
        ...
        >
            <?php foreach ($latestStories as $story): ?>
                <article class="breaking-news__item" role="listitem" data-article="<?php echo htmlspecialchars($story['slug'], ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <h3><a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($story['slug']), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($story['title'], ENT_QUOTES, 'UTF-8'); ?></a></h3>
    ...
    <div>
        ...
        <div class="card-grid">
            <?php foreach ($spotlightArticles as $article): ?>
                <article class="card">
                    <a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>" class="card__image" aria-label="<?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?>">
...
<section class="container in-depth">
    <div class="section-title-row">
        ...
        <a class="link" href="<?php echo htmlspecialchars($searchBaseUrl . '?q=analiz', ENT_QUOTES, 'UTF-8'); ?>">Tüm analizleri görüntüle</a>
    </div>
    <div class="in-depth__grid">
        <?php foreach ($inDepthArticles as $article): ?>
            <article class="in-depth__card">
                <a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>" class="in-depth__image" aria-label="<?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?>">
                    <img src="<?php echo htmlspecialchars($article['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?>">
                </a>
        ...
        <ul data-agenda-list>
            <?php foreach ($agendaArticles as $article): ?>
                <li>
                    ...
                    <p><a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?></a></p>
                </li>
            <?php endforeach; ?>
        </ul>
    </div>
    ...
    <?php foreach (array_slice($categories, 0, 3, true) as $categorySlug => $categoryName): ?>
        ...
        <div class="category-block">
            <div class="category-block__header">
                ...
                <a class="link" href="<?php echo htmlspecialchars($categoryBaseUrl . '?category=' . urlencode($categorySlug), ENT_QUOTES, 'UTF-8'); ?>">Tümünü Gör</a>
            </div>
            <div class="category-block__content">
                <?php foreach ($categoryArticles as $article): ?>
                    <article class="mini-card">
                        <a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>" class="mini-card__image" aria-label="<?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?>">
                            <img src="<?php echo htmlspecialchars($article['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?>">
                        </a>
                        <div>
                            <h3><a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?></a></h3>
