...
$errors = [];
$username = '';
$defaultRedirectPath = 'admin/dashboard.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors) && isAuthenticated()) {
        ...
        $redirectPath = sanitizeRedirect(is_string($redirectParam) ? $redirectParam : null, $defaultRedirectPath);
        $redirectUrl = assetUrl($redirectPath);
...
<body class="admin-login-body">
    <div class="admin-login">
        ...
        <a class="admin-login__back" href="<?php echo htmlspecialchars(assetUrl('index.php'), ENT_QUOTES, 'UTF-8'); ?>">Siteye dön</a>
    </div>
</body>
</html>
