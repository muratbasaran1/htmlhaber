...
$values = [
    ...
    'image' => $article['image'],
    'published_at' => (new DateTime($article['published_at']))->setTimezone(new DateTimeZone('Europe/Istanbul'))->format('Y-m-d\TH:i'),
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($articles as $idx => $existing) {
        if ($idx !== $articleIndex && $existing['slug'] === $values['slug']) {
