...
$articleNewUrl = assetUrl('admin/article-new.php');
$articleEditUrl = assetUrl('admin/article-edit.php');
$articleDeleteUrl = assetUrl('admin/article-delete.php');
?>
<section class="admin-section">
    <div class="admin-section__header">
        ...
        <a class="btn btn--primary" href="<?php echo htmlspecialchars($articleNewUrl, ENT_QUOTES, 'UTF-8'); ?>">Yeni Haber Ekle</a>
    </div>
                ...
                <?php foreach ($articles as $article): ?>
                    <tr>
                        ...
                        <td class="admin-table__actions">
                            <a class="btn btn--ghost" href="<?php echo htmlspecialchars($articleEditUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>">Düzenle</a>
                            <form method="post" action="<?php echo htmlspecialchars($articleDeleteUrl, ENT_QUOTES, 'UTF-8'); ?>" onsubmit="return confirm('Bu haberi silmek istediğinize emin misiniz?');">
