            ...
            <?php foreach ($results as $article): ?>
                <article class="card card--vertical">
                    ...
                    <div class="card__content">
                        ...
                        <h2><a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($article['slug']), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?></a></h2>
