    ...
    <article class="article">
        ...
        <div class="article__tags">
            <?php foreach ($article['tags'] as $tag): ?>
                <a class="badge badge--outline" href="<?php echo htmlspecialchars($tagBaseUrl . '?tag=' . urlencode($tag), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($tag, ENT_QUOTES, 'UTF-8'); ?></a>
            <?php endforeach; ?>
        </div>
    </article>
    <aside class="sidebar">
        <section class="widget">
            ...
            <ul class="list list--dense">
                <?php foreach ($relatedArticles as $related): ?>
                    <li>
                        <a href="<?php echo htmlspecialchars($articleBaseUrl . '?slug=' . urlencode($related['slug']), ENT_QUOTES, 'UTF-8'); ?>">
