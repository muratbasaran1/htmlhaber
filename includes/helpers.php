...
function formatTodayLongDate(): string
{
    static $formatter = null;
    static $intlAvailable = null;
    ...
    $date = new \DateTimeImmutable('now', getIstanbulTimeZone());
    ...
    $dayLabel = $dayNames[$dayKey] ?? $dayKey;

    return sprintf('%d %s %s, %s', $day, $monthLabel, $year, $dayLabel);
}
